...
void test_lrw_start(char *passw,char *tweak2) {
		...
		ret = lrw_start(1, IV1, pass, pass_len, tweak1, 0, lrw1);//#defect#HARDCODED_CREDENTIALS //#defect#HARDCODED_CREDENTIALS
...
void test_xts_start(char *passw,char *tweak2) {
		...
		ret = xts_start(1, key_1, key_2, key1_len, 0, lrw1);//#defect#HARDCODED_CREDENTIALS //#defect#HARDCODED_CREDENTIALS
...
void test_f8_start(char *passw,char *tweak2) {
		...
		ret = f8_start(1, IV1, key_1, key1_len, key_2, key2_len, 0, lrw1);//#defect#HARDCODED_CREDENTIALS //#defect#HARDCODED_CREDENTIALS
